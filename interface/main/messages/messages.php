...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $GLOBALS['assets_static_relative']; ?>/select2/dist/css/select2.min.css?v=<?php echo attr($v_js_includes); ?>">
    ...
    <script src="<?php echo $GLOBALS['assets_static_relative']; ?>/select2/dist/js/select2.full.min.js?v=<?php echo attr($v_js_includes); ?>"></script>
    ...
    <script>
        ...
        $(function () {
            ...
            if (typeof $.fn.select2 !== 'function') {
                console.warn('Select2 is not available on the Message Center page; SMS patient search is disabled.');
                $("#SMS_patient")
                    .prop('disabled', true)
                    .attr('title', <?php echo xlj('Patient SMS search is temporarily unavailable because Select2 did not load.'); ?>);
                return;
            }
