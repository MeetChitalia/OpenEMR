...
<script>
    ...
    function menu_entry(object, parentArray)
    {
        var self=this;
        ...
        if(self.header)
        {
            ...
            self.toggleOpen = function (data, event) {
                ...
                if (parentArray) {
                    ko.utils.arrayForEach(parentArray(), function (sibling) {
                        if (sibling !== self && sibling.isOpen) sibling.isOpen(false);
                    });
                }
            ...
            {
                var childObj=new menu_entry(object.children[childIdx], self.children);
    ...
    {
        var newEntry=new menu_entry(object, target);
