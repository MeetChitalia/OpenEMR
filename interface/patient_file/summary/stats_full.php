                    ...
                    <table class="table">
                        ...
                        foreach ($ISSUE_TYPES as $focustype => $focustitles) {
                            ...
                            while ($row = sqlFetchArray($pres)) {
                                ...
                                "list_id = ?", array($rowid));
                                $encounter_count = ($ierow && is_array($ierow)) ? $ierow['count'] : 0;
                                ...
                                echo "  <button value='" . attr($encounter_count) . "' class='btn btn-primary btn-sm editenc btn-edit' id='" . attr($rowid) . "'>" . xlt("Edit") . "</button>";
                                echo "  </td>";
                                echo " </tr>\n";
                            }
                        }
