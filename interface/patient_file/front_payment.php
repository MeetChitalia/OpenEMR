        ...
        foreach ($_POST['form_upay'] as $enc => $payment) {
            ...
            if ($amount = $payment) {
                ...
                if ($_REQUEST['radio_type_of_payment'] == 'copay') {//copay saving to ar_session and ar_activity tables
                    ...
                    $sequence_no = ensureArray($sequence_no);
                    $insrt_id = sqlInsert(
