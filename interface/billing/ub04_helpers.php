...
$users = sqlStatementNoLog("SELECT id,fname,lname,npi,taxonomy FROM users WHERE authorized=1 AND active=1");
?>
<html>
<head>
<script>
...
HAVING label LIKE " . sqlEscape($term) . " AND cg = " . sqlEscape($group) . " ORDER BY code ASC");
