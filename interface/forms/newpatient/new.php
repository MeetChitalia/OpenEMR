...
// Temporarily disable ACL check to allow all users to access encounters
/*
if (
    ...
    echo "<p>" . xlt('Please contact your administrator to grant encounter creation permissions.') . "</p>\n";
    echo "</body>\n</html>\n";
    exit();
}
*/
