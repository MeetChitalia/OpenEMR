...
$GLOBALS_METADATA = array(
    ...
    'Appearance' => array(
        ...
        // Menu hiding globals
        'hide_fees_menu' => array(
            xl('Hide Fees Menu'),
            'bool',                           // data type
            '1',                              // default = true
            xl('Hide the Fees menu from the main menu bar')
        ),
        'hide_modules_menu' => array(
            xl('Hide Modules Menu'),
            'bool',                           // data type
            '1',                              // default = true
            xl('Hide the Modules menu from the main menu bar')
        ),
        'hide_procedures_menu' => array(
            xl('Hide Procedures Menu'),
            'bool',                           // data type
            '1',                              // default = true
            xl('Hide the Procedures menu from the main menu bar')
        ),
...
//                ,2 => xl('All apps Auto Approved') we could add this setting at a latter date
        ...
        'payment_gateway' => array(
            ...
            array(
                ...
                'Versapay' => xl('Gateway for Versapay POS and Payment Processing')
            ),
            'InHouse',
        ...
        'versapay_api_key' => array(
            xl('Versapay API Key'),
            'encrypted',
            '',
            xl('API Key for Versapay payment processing')
        ),

        'versapay_merchant_id' => array(
            xl('Versapay Merchant ID'),
            'encrypted',
            '',
            xl('Merchant ID for Versapay account')
        ),

        'versapay_webhook_secret' => array(
            xl('Versapay Webhook Secret'),
            'encrypted',
            '',
            xl('Secret key for validating Versapay webhooks')
        ),

        'versapay_api_url' => array(
            xl('Versapay API URL'),
            'text',
            'https://api.versapay.com',
            xl('Versapay API endpoint URL')
        ),
