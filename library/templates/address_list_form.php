...
<script type="text/javascript">
    ...
    // Prevent duplicate declarations when loaded multiple times via AJAX
    if (typeof window.addressWidgets === 'undefined') {
        window.addressWidgets = [];
    }
    if (typeof window.ADDRESS_ACTION_VALUES === 'undefined') {
        window.ADDRESS_ACTION_VALUES = {
            'DELETE': 'INACTIVATE'
            ,'ADD': 'ADD'
            ,'UPDATE': 'UPDATE'
        };
    ...
    var addressWidgets = window.addressWidgets;
    var ADDRESS_ACTION_VALUES = window.ADDRESS_ACTION_VALUES;
    if (typeof datePickerSettings === 'undefined') {
